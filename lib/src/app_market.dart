...
class AppMarket {
  ...
  /// 小米
  static const xiaoMi =
      AppMarketInfo('xiaoMi', 'com.xiaomi.market', 'com.xiaomi.market.ui.AppDetailActivity');
  ...
  /// vivo
  static const vivo =
      AppMarketInfo('vivo', 'com.bbk.appstore', 'com.bbk.appstore.ui.AppStoreTabActivity');
  ...
  static const qiHoo = AppMarketInfo(
      'qiHoo', 'com.qihoo.appstore', 'com.qihoo.appstore.distribute.SearchDistributionActivity');

  /// 应用宝
  static const tencent = AppMarketInfo(
      'tencent', 'com.tencent.android.qqdownloader', 'com.tencent.pangu.link.LinkProxyActivity');
